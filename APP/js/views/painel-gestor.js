...
export async function painelGestorView(_params, app) {
  ...
  async function reload() {
    ...
    let q = supabase.from('atividades').select('*, profiles!atividades_gerente_id_fkey(nome, email, cidade, estado)').eq('cancelada', false).neq('tipo', 'visita').order('created_at', { ascending: false });
